package de.lessvoid.resourceloader;
...
import de.lessvoid.resourceloader.location.ClasspathLocation;
import de.lessvoid.resourceloader.location.FileSystemLocation;
import de.lessvoid.resourceloader.location.ResourceLocation;
 ...
 *
 * @author Kevin Glass
 * @auther void (made it a none static class and some minor changes)
 */
public class ResourceLoader {
  /** The list of locations to be searched */
  private List<ResourceLocation> locations = new ArrayList<ResourceLocation>();
